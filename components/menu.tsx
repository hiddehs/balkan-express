...
export const Menu: React.FC<Rectangle8Props> = React.memo(
  (props: Rectangle8Props) => {
    ...
    return (
      <div
        ...
        <Link className="hover:opacity-80 transition duration-100 relative"
              href={'https://www.instagram.com/balkanexpress2023/'}
              target="_blank">
  ...
  <span
    className="relative inline-flex rounded-full h-1.5 w-1.5 bg-red-500"></span>
</span>
          <svg
            width="18"
            height="19"
